...
func TestRateLimiter_Accept(t *testing.T) {
	t.Run("Success - User on time", func(t *testing.T) {
	...
	t.Run("Success - User waiting time window", func(t *testing.T) {
	...
	t.Run("Success - Two users on time", func(t *testing.T) {
	...
	t.Run("Fail - User exceeds rate", func(t *testing.T) {
		clMock := createClock(1, 2, 3)
	...
	t.Run("Fail - First user on time, Second exceeds rate", func(t *testing.T) {
